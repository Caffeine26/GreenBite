            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  RichText(
                    text: const TextSpan(
                      ...
                      children: [
                        ...
                        TextSpan(
                          text:
                              ' is a community-driven mobile application designed to combat food waste by helping users find creative and sustainable ways to use leftover ingredients. Our mission is to empower people to reduce food waste while fostering a community that shares ideas, recipes, and support.',
                        ),
                      ],
                    ),
                  ),
                  ...
                  const BulletPoint(
                    text:
                        'Discover innovative recipes to make the most of your leftovers.',
                  ),
                  const SizedBox(height: 6),
                  const BulletPoint(
                    text:
                        'Connect with a community that shares your passion for reducing food waste.',
                  ),
                  const SizedBox(height: 6),
                  const BulletPoint(
                    text:
                        'Access helpful tips, articles, and community stories to stay inspired.',
                  ),
