...
class _RecipeDetailState extends State<RecipeDetail> {
  ...
  void _onNavTap(int index) {
    ...
    if (index == 0) _scrollToSection(cookbooksKey);
    else if (index == 1) _scrollToSection(groceryKey);
    else if (index == 2) _scrollToSection(favoriteKey);
  }
    ...
    return Column(
      children: steps.asMap().entries.map((entry) {
        ...
        return Container(
          ...
          border: Border.all(color: Colors.grey[300]!), // Using ! operator
        ),
          child: Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
